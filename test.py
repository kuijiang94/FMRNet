...
parser.add_argument('--weights', default='./checkpoints/Deraining/models/FMRNet/model_best.pth', type=str, help='Path to weights')
...
for dataset in datasets:
    ...
    result_dir  = os.path.join(args.result_dir, dataset, 'FMRNet_best')
